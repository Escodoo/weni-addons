...
//                    style_image_body_l2 = "background-color:" + ks_rgba_background_color + ";";
        ...
        ks_container_option: function(chart_title, ksIsDashboardManager,ks_dashboard_list, chart_id, chart_family, chart_type, ksChartColorOptions,ks_show_records,ks_query_type){
            var container_data = {
                ...
                ks_show_records: ks_show_records,
                ks_query_type: false,
            }
...
//            })).addClass('ks_dashboarditem_id');
            ...
            var container_data = this.ks_container_option(chart_title, self.ks_dashboard_data.ks_dashboard_manager,self.ks_dashboard_data.ks_dashboard_list, chart_id, chart_family, chart_type, this.ksChartColorOptions,item.ks_show_records,item.ks_data_calculation_type);
