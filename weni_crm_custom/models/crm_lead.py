...
class CrmLead(models.Model):
    ...
    weni_linkedin_profile = fields.Char(
        string="Linkedin Profile"
    )
    weni_lost_date = fields.Date(
        'Lost Date',
        track_visibility='always'
    )
    weni_is_freezed = fields.Boolean(
        string='Is freezed'
    )
    ...
    weni_use_chatbot_solution = fields.Boolean(
        string="Use Chatbot Solution"
    )
    weni_systems_used = fields.Html(
        string='Systems Used'
    )
    ...
    # Diagnostic
    weni_current_situation = fields.Html(
        string='Current Situation'
    )
    weni_project_pain_primary = fields.Html(
        string='Primary Problems'
    )
    weni_project_pain_secondary = fields.Html(
        string='Secondary Problems'
    )
    weni_implication = fields.Html(
        string='Implication'
    )
    weni_need = fields.Html(
        string='Need'
    )
    weni_project_integration = fields.Html(
        string='Integrations'
    )
    weni_channels_used = fields.Html(
        string='Channels Used'
    )
